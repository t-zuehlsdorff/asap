...
var_dump(\asap\lib\scout\compareVersions('1.1', 'v1.1.1') === true);
var_dump(\asap\lib\scout\compareVersions('1.1', 'v1.0.1') === false);
var_dump(\asap\lib\scout\compareVersions('1.1', 'v1.1') === false);
